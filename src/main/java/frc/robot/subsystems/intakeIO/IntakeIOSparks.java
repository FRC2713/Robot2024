...
public class IntakeIOSparks implements IntakeIO{
    ...
    public IntakeIOSparks()
    {
        ...
        this.leftMotor = new CANSparkMax(Constants.RobotMap.INTAKE_LEFT_MOTOR_CAN_ID,MotorType.kBrushless);
        this.rightMotor = new CANSparkMax(Constants.RobotMap.INTAKE_RIGHT_MOTOR_CAN_ID,MotorType.kBrushless);
