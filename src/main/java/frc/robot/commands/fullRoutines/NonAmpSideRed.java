...
public class NonAmpSideRed extends SequentialCommandGroup {

  private ChoreoTrajectory traj1, traj2, traj3;

  public NonAmpSideRed() {
    traj1 = Choreo.getTrajectory("Non Amp Side.1").flipped();
    traj2 = Choreo.getTrajectory("Non Amp Side.2").flipped();
    traj3 = Choreo.getTrajectory("Non Amp Side.3").flipped();
