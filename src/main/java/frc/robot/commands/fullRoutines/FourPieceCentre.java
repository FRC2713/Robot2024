...
public class FourPieceCentre extends SequentialCommandGroup {

  private ChoreoTrajectory traj1, traj2, traj3, traj4;

  public FourPieceCentre() {
    traj1 = Choreo.getTrajectory("Four Piece Centre.1").flipped();
    traj2 = Choreo.getTrajectory("Four Piece Centre.2").flipped();
    traj3 = Choreo.getTrajectory("Four Piece Centre.3").flipped();
    traj4 = Choreo.getTrajectory("Four Piece Centre.4").flipped();
